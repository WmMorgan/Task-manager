    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-title">Задания</li><!-- /.menu-title -->
                <li>
                    <a href="<?= Url::to(['task/']) ?>"> <i class="menu-icon fa fa-cogs"></i>Мои задания</a>
                </li>
                <li>
                    <a href="<?= Url::to(['my-tasks/']) ?>"> <i class="menu-icon fa fa-table"></i>Задания на меня</a>
                </li>
                <li>
                    <a href="<?= Url::to(['my-tasks/expiring-tasks']) ?>"> <i class="menu-icon fa fa-clock-o"></i>Истекающие задачи </a>
                </li>

                <?php if(\Yii::$app->user->can('admin')): ?>

                    <li>
                        <a href="<?= Url::to(['statistics/']) ?>"> <i class="menu-icon fa fa-users" aria-hidden="true"></i>Количества задач </a>
                    </li>
                    <li>
                        <a href="<?= Url::to(['statistics/task-completion-time']) ?>"> <i class="menu-icon fa fa-tint" aria-hidden="true"></i>Среднее время выполнения задачи </a>
                    </li>
                <?php endif; ?>
            ...
            <div class="header-menu">
                ...
                <div class="user-area dropdown float-right">
                    <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="user-avatar rounded-circle" src="<?= \app\models\User::getAvatar() ?>" alt="User Avatar">
                    </a>
